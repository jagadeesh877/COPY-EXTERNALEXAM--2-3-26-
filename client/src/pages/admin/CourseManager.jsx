      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-1">
            Manage core courses and faculty distributions.
          </p>
        </div>
      ...
      <div className="bg-white p-10 rounded-[40px] shadow-xl border border-gray-100 min-h-[650px] transition-all relative">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-6 relative z-10">
          ...
          <div className="flex gap-4 w-full sm:w-auto">
            <CustomSelect
              className="px-8 bg-gray-50 border-2 border-transparent focus:border-[#003B73] rounded-[24px] font-black text-[#003B73] outline-none transition-all appearance-none cursor-pointer flex-1 sm:flex-none sm:min-w-[200px]"
              value={filterDept}
                    ...
                    <td className="px-8 py-6 text-left">
                      <div className="flex items-center gap-4">
                        <div className="w-14 h-14 bg-white rounded-2xl flex flex-col items-center justify-center font-black shadow-sm border border-gray-100 group-hover:scale-110 transition-all duration-500">
                          <span className="text-[#003B73] text-lg leading-none">
                            {sub.code}
                          </span>
                        </div>
                        <div>
                      ...
                      {sub.assignments?.length > 0 ? (
                        <div className="flex flex-wrap gap-2">
                          {sub.assignments.map((a, i) => (
                            <div
                              key={i}
                              className="flex items-center gap-2 bg-white px-3 py-2 rounded-xl border border-gray-100 shadow-sm group/tag hover:border-[#003B73] transition-all"
                            >
            ...
            <div className="flex justify-between items-center mb-10">
              <div>
                ...
                <p className="text-gray-500 font-bold text-sm mt-1">
                  Initialize a new academic course.
                </p>
              </div>
              <button
            ...
            <form onSubmit={handleCreateCourse} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <CustomSelect
                    className={`w-full border-2 border-transparent focus:border-[#003B73] rounded-3xl font-black outline-none transition-all appearance-none cursor-pointer ${newCourse.type === "COMMON" ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-gray-50 text-[#003B73]"}`}
                    value={
                      newCourse.type === "COMMON" ? "" : newCourse.department
                    }
                    onChange={(e) =>
